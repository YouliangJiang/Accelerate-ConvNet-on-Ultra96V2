...
################################################################
# This is a generated script based on design: ConvNet
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: convnet_0, and set properties
  set convnet_0 [ create_bd_cell -type ip -vlnv zju.ccai.rc4ml:hls:convnet:1.0 convnet_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins convnet_0/in_r]
  ...
  connect_bd_intf_net -intf_net convnet_0_out_r [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins convnet_0/out_r]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins convnet_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs convnet_0/s_axi_control/Reg] -force
